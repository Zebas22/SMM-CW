...
draw_text_transformed((x + 17), (y + 42), string_hash_to_newline(texto),0.3335,0.3335,0)
draw_text_transformed((x + 17), (y + 84), string_hash_to_newline(texto2),0.3335,0.3335,0)
draw_set_halign(fa_left)