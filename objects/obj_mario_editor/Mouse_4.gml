if (obj_levelmanager.editor == 1 && global.resource_create == 0 && obj_editormanager.zoom == 0 && (obj_editormanager.expand_open == 0 || obj_levelmanager.editor_sonidos == 1) && (follow == 0) && (!collision_rectangle((floor((mouse_x / 16)) * 16), (floor((mouse_y / 16)) * 16), ((floor((mouse_x / 16)) * 16) + 15), ((floor((mouse_y / 16)) * 16) + 15), obj_parent_layout, 1, 1)) && (!place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_parent_layout)))
{
