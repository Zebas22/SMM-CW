...
{
    mobile_keys[0] = virtual_key_add((30 * s), (82 * s), (32 * s), (64 * s), global.arriba)
    mobile_keys[1] = virtual_key_add((30 * s), (174 * s), (32 * s), (64 * s), global.abajo)
    mobile_keys[2] = virtual_key_add((-32 * s), (144 * s), (64 * s), (32 * s), global.izquierda)
    mobile_keys[3] = virtual_key_add((60 * s), (144 * s), (64 * s), (32 * s), global.derecha)
}
