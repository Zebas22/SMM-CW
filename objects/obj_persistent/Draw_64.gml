...
if global.showfps && room != rm_logo && room != rm_intro && room != rm_verificacion && room != rm_credito
{
    ...
    if (fps >= 60)
        draw_text_colour(2, 2, string_hash_to_newline((string(fps_real) + " FPS")), c_lime, c_lime, c_lime, c_lime, 1)
    else if (fps < 60)
        draw_text_colour(2, 2, string_hash_to_newline((string(fps_real) + " FPS")), c_yellow, c_yellow, c_yellow, c_yellow, 1)
    else if (fps < 30)
        draw_text_colour(2, 2, string_hash_to_newline((string(fps_real) + " FPS")), c_red, c_red, c_red, c_red, 1)
}
