if (hold == 0 && ready == 0 && (!(place_meeting(x, y, obj_solid))) && (!(place_meeting(x, y, obj_physicssolid))) && (!(place_meeting(x, y, obj_bullebill_base))))
{
    event_user(0)
    hold = 1
    if (other.sprite_index == spr_SMB_shell_empty || other.sprite_index == spr_SMB_shell_empty_night || other.sprite_index == spr_SMB3_shell_empty || other.sprite_index == spr_SMB3_shell_empty_night || other.sprite_index == spr_shell_buzzy_empty)
        hold_obj = instance_create(other.x, other.y, obj_shell_empty)
    else if (other.sprite_index == spr_SMB_shell_empty_spiny || other.sprite_index == spr_SMB3_shell_spiny_empty || other.sprite_index == spr_shell_spiny_empty)
