...
else
{
    ...
    if (koopainside != 0)
    {
        ...
        {
            case -1:
                if (sprite_index == spr_SMB_shell_buzzy || sprite_index == spr_SMB_shell_buzzy_night || sprite_index == spr_SMB3_shell_buzzy || sprite_index == spr_SMB3_shell_buzzy_night || sprite_index == spr_shell_buzzy )
                {
                    with (instance_create(x, y, obj_buzzybeetle))
                        direct = other.direct
                    instance_destroy()
                }
                else if (sprite_index == spr_SMB_shell_buzzy_b || sprite_index == spr_SMB_shell_buzzy_night_b || sprite_index == spr_SMB3_shell_buzzy_b || sprite_index == spr_SMB3_shell_buzzy_night_b || sprite_index == spr_shell_buzzy_b)
                {
                    with (instance_create(x, y, obj_buzzybeetle_b))
                        direct = other.direct
                    instance_destroy()
                }
                else if (sprite_index == spr_SMB_spiny_dead || sprite_index == spr_SMB3_spiny_dead || sprite_index == spr_spiny_dead )
                {
