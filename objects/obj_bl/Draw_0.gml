...
if (mensaje != "")
{
    ...
    draw_text_transformed((camera_get_view_x(view_get_camera(0)) + (camera_get_view_width(view_get_camera(0)) / 2)), (camera_get_view_y(view_get_camera(0)) + 170), string_hash_to_newline(mensaje),0.3334,0.3334,0)
