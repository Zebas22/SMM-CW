...
if (col_enemy && col_enemy.hardness < 99 && col_enemy.object_index != obj_grinder && col_enemy.object_index != obj_piranhaplant && col_enemy.object_index != obj_rocky && col_enemy.object_index != obj_boo)
{
    with (col_enemy)
    {
