    ...
    else if (other.bbox_bottom < ((bbox_top - v_speed) + altura))
    {
        if (stomp != 3 && stomp != 5 && stomp != 6 && (other.stompstyle == 1 || global.yoshi == 1 || global.yoshi == 2))
        {
            if (stomp == 0 || stomp == 4)
            {
                ...
                else if (object_index == obj_charginchuck || object_index == obj_cannonball || object_index == obj_cannonball_red)
                {
                    with (other.id)
                        event_user(1)
        ...
        else if (global.powerup != -80 && (stomp == 0 || stomp == 3 || stomp == 5))
        {
            ...
            if (si == 1)
            {
                if (object_index == obj_shell_held && (sprite_index == spr_SMB_shell_empty_spiny || sprite_index == spr_SMB3_shell_spiny_empty || sprite_index == spr_shell_spiny_empty ))
                {
                    with (other.id)
                        event_user(0)
                    exit
