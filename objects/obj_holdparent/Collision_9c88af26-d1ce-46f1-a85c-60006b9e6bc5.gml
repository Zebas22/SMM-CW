if (held == 0)
{
    ...
    if (other.bbox_bottom < ((bbox_top - vspeed) + alturabo) && other.vspeed > 0)
        event_user(1)
    else if (scr_canhold() == 0 && inmune == 0 && (object_index == obj_bobomb_hold || object_index == obj_galoomba_hold || object_index == obj_galoomba_hold2 || object_index == obj_mechakoopa_held || object_index == obj_link_bomb))
    {
