...
if (global.pp == 0)
{
    ...
    if (vspeed < 0 && (collision_rectangle(bbox_left, (bbox_top - 1), bbox_right, bbox_top, obj_solid, 1, 0) || collision_rectangle(bbox_left, (bbox_top - 1), bbox_right, bbox_top, obj_physicssolid, 1, 0) || collision_rectangle(bbox_left, (bbox_top + 1), bbox_right, (bbox_top + 1), obj_slopeparent, 1, 0) || collision_rectangle(bbox_left, (bbox_top - 1), bbox_right, bbox_top, obj_bullebill_base, 1, 0) || (pswitch && pswitch.held == 0 && (pswitch.y + 16) < bbox_top) || (one_2 && (bbox_top + 5) >= one_2.bbox_bottom)))
    {
        if (state > 1 && canjump == 1)
        {
            while (collision_rectangle(bbox_left, (bbox_top + 1), bbox_right, (bbox_top + 1), obj_solid, 1, 0) || collision_rectangle(bbox_left, (bbox_top + 1), bbox_right, (bbox_top + 1), obj_slopeparent, 1, 0))
                y++
        }
        vspeed = 0
        ...
        var block_col = collision_rectangle(bbox_left, (bbox_top - 2), bbox_right, bbox_top, obj_blockparent, 1, 0)
