...
if (activated == 1)
{
    if instance_exists(obj_mario) and count < 3
    {
...
if count > 2{
if (obj_lakitu.y < camera_get_view_y(view_camera[0]) + 32){
    instance_destroy()
	instance_destroy(obj_cloud_lakitu)
}
}