if (global.apariencia == 0)
{
    if instance_exists(obj_ground3)
    {
        ...
        else if (global.bg_level != "castle") && (!instance_exists(obj_flagpole)) && (!instance_exists(obj_SMB_castle))
        {
...
else if (global.apariencia == 2)
{
    if instance_exists(obj_ground3)
    {
        if (global.bg_level == "castle") && (!instance_exists(obj_axe_smw))
            instance_create((obj_ground3.x + 16), (obj_ground3.y - 16), obj_axe_smw)
        else if (global.bg_level != "castle") && (!instance_exists(obj_goalgate))
...
else if (global.apariencia == 4)
{
    if instance_exists(obj_ground3)
    {
        ...
        else if (global.bg_level != "castle") && (!instance_exists(obj_crystalorb))
        {
